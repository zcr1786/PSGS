...
def load_data_long(dataset, device):
    ...
    mole_dict = {1: "H", 2: "He", 3: "Li", 4: "Be", 5: "B", 6: "C", 7: "N", 8: "O", 9: "F", 10: " Ne",
                ...
                81:"Tl", 82:"Pb", 83:"Bi" , 30:"Zn" , 33:"As" ,
                 56:"Ba" , 25:"Mn" , 60:"Nd" ,48:"Cd" ,27:"Co",49:"In", 66:"Dy" ,70:"Yb",38:"Sr", 64:"Gd",42:"Mo",63:"Eu",23:"V"}

    pair_list = ["Br", "Cl", "Si", "Na", "Ca", "Ge", "Cu", "Au", "Sn", "Tb", "Pt", "Re", "Ru", "Bi", "Li", "Fe", "Sb", "Hg",
                 "Pb", "Se", "Ag","Cr","Pd","Ga","Mg","Ni","Ir","Rh","Te",
                 "Ti","Al","Zr","Tl","Zn","As","Ba","Mn","Nd","Cd","Co","In","Dy","Yb","Sr","Gd","Mo","Eu"]
...
def load_data(dataset, device):
    ...
    for line in file:
        ...
        # train_labels[len(train_adjlists)]= label
        train_adjlists.append(adj_list)
        train_features.append(torch.FloatTensor(feature).to(device))
        train_sequence.append(torch.tensor(smiles_seq))
    file.close()
    ...
    test_sequence = []
    test_labels = np.zeros([te_len, label_len])
    print('test_label shape is {}'.format(test_labels.shape))
    for line in file:
        smiles = line.split("\t")[1]
        # print(smiles)
        col_i = 0
        ...
        # test_labels[len(test_adjlists)] = label
        test_adjlists.append(adj_list)
        test_features.append(torch.FloatTensor(feature).to(device))
        test_sequence.append(torch.tensor(smiles_seq))
    file.close()
